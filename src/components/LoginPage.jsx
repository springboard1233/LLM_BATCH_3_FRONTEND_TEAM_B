      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-black/30 backdrop-blur-lg border border-white/10 rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded bg-black/40 border-white/20 text-emerald-500 focus:ring-emerald-400"
                />
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="flex items-center justify-center gap-2 py-2 px-4 bg-white/5 border border-white/10 rounded-lg text-white hover:bg-white/10 transition-colors"
            >
