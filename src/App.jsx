...
const sampleTransactions = [
  { id: 'TXN001', customerId: 'CUST001', amount: 1500.00, status: 'Legitimate', channel: 'Online Banking', date: '2024-01-15', riskLevel: 'Low', kycStatus: true, kyc: true },
  { id: 'TXN002', customerId: 'CUST002', amount: 25000.00, status: 'Fraud', channel: 'Wire Transfer', date: '2024-01-14', riskLevel: 'High', kycStatus: false, kyc: false },
  { id: 'TXN003', customerId: 'CUST003', amount: 750.00, status: 'Legitimate', channel: 'Mobile App', date: '2024-01-13', riskLevel: 'Low', kycStatus: true, kyc: true },
  { id: 'TXN004', customerId: 'CUST004', amount: 3200.00, status: 'Safe', channel: 'ATM', date: '2024-01-12', riskLevel: 'Low', kycStatus: true, kyc: true },
  { id: 'TXN005', customerId: 'CUST005', amount: 50000.00, status: 'Fraud', channel: 'Branch', date: '2024-01-11', riskLevel: 'High', kycStatus: false, kyc: false },
  { id: 'TXN006', customerId: 'CUST006', amount: 890.50, status: 'Legitimate', channel: 'POS', date: '2024-01-10', riskLevel: 'Low', kycStatus: true, kyc: true },
  { id: 'TXN007', customerId: 'CUST007', amount: 12500.00, status: 'Fraud', channel: 'Web', date: '2024-01-09', riskLevel: 'High', kycStatus: false, kyc: false },
  { id: 'TXN008', customerId: 'CUST008', amount: 450.75, status: 'Safe', channel: 'Mobile', date: '2024-01-08', riskLevel: 'Low', kycStatus: true, kyc: true },
  { id: 'TXN009', customerId: 'CUST009', amount: 8750.00, status: 'Fraud', channel: 'ATM', date: '2024-01-07', riskLevel: 'High', kycStatus: false, kyc: false },
  { id: 'TXN010', customerId: 'CUST010', amount: 2100.25, status: 'Legitimate', channel: 'Online Banking', date: '2024-01-06', riskLevel: 'Medium', kycStatus: true, kyc: true },
  { id: 'TXN011', customerId: 'CUST011', amount: 675.00, status: 'Safe', channel: 'Mobile App', date: '2024-01-05', riskLevel: 'Low', kycStatus: true, kyc: true },
  { id: 'TXN012', customerId: 'CUST012', amount: 15000.00, status: 'Fraud', channel: 'Wire Transfer', date: '2024-01-04', riskLevel: 'High', kycStatus: false, kyc: false }
]
...
const renderMainContent = () => {
  switch (activeSection) {
    ...
    case 'reports':
        return <Reports transactions={sampleTransactions} />
